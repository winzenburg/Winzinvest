...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('/Users/pinchy/.openclaw/workspace/trading/logs/snapshot_resumable.log'),
...
class ResumableSnapshotFetcher:
    ...
    async def connect(self):
        ...
        try:
            await self.ib.connectAsync('127.0.0.1', 4002, clientId=103)
...
async def main():
    ...
    symbol_file = WATCHLIST_DIR / "top_800_broader_sp500_nasdaq_russell.csv"
