...
1. **Profit-take** at 80% premium decay → buy-to-close (PROFIT_ROLL if `reopen_after_profit_take: true`)
...
|---|---|---|
| `profit_take_pct` | 0.80 | Close when premium decayed this much |
...
| Goal | Change |
|---|---|
| Take profits earlier | Lower `profit_take_pct` to 0.60 or 0.70 |
| Let winners run longer | Raise `profit_take_pct` to 0.90 (max decay before near-expiry risk increases) |
